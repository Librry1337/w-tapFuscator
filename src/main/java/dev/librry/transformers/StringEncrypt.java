...
import dev.librry.utils.StringMethod;
...
public class StringEncrypt extends Transformer {

	public static boolean check=false;

	public StringEncrypt(Obfuscator obfuscator) {
		super(obfuscator);
	}
	...
	public void visit(ClassNode classNode) {
        ...
        for(MethodNode methodNode : classNode.methods){
            String splitKey = "ALLARMKARANDETECT";
